...
import com.intellisyscorp.fitzme_android.dropdown.WethearCategory;
...
public class WetherDropdownAdapter extends RecyclerView.Adapter<WetherDropdownAdapter.CategoryViewHolder> {

    private List<WethearCategory> categories;
    private CategorySelectedListener categorySelectedListener;

    public WetherDropdownAdapter(List<WethearCategory> categories) {
        super();
    ...
    public void onBindViewHolder(@NonNull CategoryViewHolder holder, final int position) {
        final WethearCategory category = categories.get(position);
    ...
    public interface CategorySelectedListener {
        void onCategorySelected(int position, WethearCategory category);
    }
}
